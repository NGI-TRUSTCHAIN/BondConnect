...
export const readBonds = createAsyncThunk(
	'bond/readBonds',
  async (_, { rejectWithValue }) => { 
    try {
      const response = await fetch('http://localhost:8080/bonds', {method: 'GET'});
...
export const newBond = createAsyncThunk(
	'bond/createBond',
  async (formData: Bond, { rejectWithValue }) => { 
...
export const updateBond = createAsyncThunk(
  ...
  async (formData: Bond, { rejectWithValue }) => { 
    console.log('Before sending:', JSON.stringify(formData));
    try {
      const response = await fetch(`http://localhost:8080/update/${formData._id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
...
export const saveBond = createAsyncThunk(
	'bond/saveBond',
  async (formData: Bond, { rejectWithValue }) => { 
    try {
...
export const createTransferHistoric = createAsyncThunk(
  ...
  async (transferData: TransferInfo, { rejectWithValue }) => { 
    ...
    try {
      const response = await fetch('http://localhost:8080/createTransferHistoric', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
...
export const readTransferHistory  = createAsyncThunk(
	'bond/readTransferHistory',
  async (_, { rejectWithValue }) => { 
    try {
      const response = await fetch('http://localhost:8080/transferHistory', {method: 'GET'});
...
export const createSaleReceipt = createAsyncThunk(
  ...
  async (saleReceipt: SaleReceipt, { rejectWithValue }) => { 
    ...
    try {
      const response = await fetch('http://localhost:8080/createSaleReceipt', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
...
export const createSettlementReceipt = createAsyncThunk(
  ...
  async (settlementReceipt: SettlementReceipt, { rejectWithValue }) => { 
    ...
    try {
      const response = await fetch('http://localhost:8080/createSettlementReceipt', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
